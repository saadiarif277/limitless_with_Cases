<template>
    ...
    <div class="h-full flex flex-col">
                ...
                <template #actions>
                    <template v-if="referral">
                        <div class="flex gap-2">
                            <v-button color="white" :href="route('panel.admin.appointments.create', { referral_id: referral.data.referral_id })">
                                Create Appointment
                            </v-button>
        ...
        <x-referral-edit-form
            ...
            :update-route="'panel.admin.referrals.update'"
            :destroy-document-route="'panel.admin.documents.destroy'"
        />
    </div>
</template>
        ...
        deleteRequest() {
            this.$alert().confirm(() => {
                return new Promise((resolve, reject) => {
                    this.deleteForm.delete(this.route('panel.admin.referrals.destroy', { referral: this.referral.data.referral_id }), {
                        onSuccess: () => {
