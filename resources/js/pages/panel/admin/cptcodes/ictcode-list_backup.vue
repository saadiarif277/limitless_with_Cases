<template>
    <v-inertia-head title="ICT Codes List" />
    ...
    <div class="h-full flex flex-col">
        <v-content-body class="border-b border-gray-200">
            <v-section-heading>
                ...
                <template #actions>
                    <v-button :href="route('panel.admin.ictcodes.create')">
                        Create ICT Code
                    </v-button>
                </template>
        ...
        <!-- Table for ICT Codes -->
        <v-app-model-table :columns="columns" :data="ictCodes.data" :links="ictCodes.links" :meta="ictCodes.meta">
            <!-- Custom template for the 'code' column -->
            <template v-slot:column_code="{ row: ictCode }">
