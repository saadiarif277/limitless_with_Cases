                ...
                <v-section-heading>
                    <template #title>
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-primary-500">Update Case</span>
                        </div>
                    </template>
                </v-section-heading>
        <div class="flex gap-4 mt-6 mr-2">
            <v-button @click="markCaseComplete" class="bg-success w-50" color="green">
    Mark it Complete
</v-button>
<v-button @click="openReductionModal" class="bg-warning w-50" color="orange">
    Send for Reduction
</v-button>
...
<v-button @click="markLostCase" class="bg-danger w-50" color="red">
    Mark Lost Case
</v-button>
